...
<form action="" method="POST">
	...
	<table class="tb-create">
        ...
        <tr>
			<td>ID Outlet :<br><input type="text" name="id_outlet" value="<?php echo $row['id_outlet']; ?>"class="input-field"></td>
		</tr>
		<tr>
			<td>
...
$res = $kdb->query("UPDATE user SET nama= '$nama', username = '$user', password = '$pass', id_outlet = '$id_outlet' WHERE user.id_user = '$id'");
	if($res){
